...
print("number of unique nodes in the graph = " + str(
    len(set(connection_feeds + connection_expr_temp + connection_infrule_temp))))
...
# wc -bin temp_node_ID_sorted_uniq 
...
print('number of nodes found: ' + str(len(
    list_of_nodes)))  # this contains a bunch of redundant entries. However, neither dics nor lists are hashable to determine collisions
...
for this_node_dic in pruned_list_of_nodes:
    nodes_file.write(
        this_node_dic['temp index'] + "," + this_node_dic['type'] + "," + this_node_dic['perm index'] + "\n")
