...
feed_temp_indx = physgraf.find_new_indx(
    list_of_feeds, 1000000, 9999999, "feed temporary index: ")
expr_temp_indx = physgraf.find_new_indx(
    connection_expr_temp,
    1000000,
    9999999,
    "expression temporary index: ")
infrule_temp_indx = physgraf.find_new_indx(
...
physgraf.check_connection_DB_steps_for_single_inf_rule(
