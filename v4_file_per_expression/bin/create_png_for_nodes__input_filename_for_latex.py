...
print("foldername: "+folder_name+"; file name with extension: "+filename_with_extension+"; file extension:  "+file_extension+"; filename without extension: "+filename_without_extension)
...
with open(folder_name+"/"+filename_with_extension, 'r') as f:
  ...
  physgraf.make_picture_from_latex_expression(output_filename_no_extension,folder_name,latex_expression,picture_extension)
