...
#   print(operator_name)
  ...
  if ((redraw_inference_rule_pictures_boolean) or ((not redraw_inference_rule_pictures_boolean) and not (os.path.isfile(op_pictures+'/'+operator_name+'.'+extension)))): # if file does not exist, redraw
    physgraf.make_picture_from_latex(operator_name,op_pictures,operator_name,extension)
