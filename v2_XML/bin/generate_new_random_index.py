...
# input: none
# output: random numeric identifiers which do not already exist in the
...
def find_unique_id(lower_bound, upper_bound, arry, id_name):
    ...
    while (not unique_id_found):
        # infrule_temporary_unique_id is a unique digit number
        new_id = random.randint(lower_bound, upper_bound)
...
find_unique_id(1000000, 9999999, infrule_temporary_unique_id_ary,
               "inference rule numeric identifier")  # 7 digits

find_unique_id(
    1000000,
    9999999,
    expression_temporary_unique_id_ary,
    "expression numeric identifier")  # 7 digits
...
print("\nexpression database:")
find_unique_id(1000000000, 9999999999, expression_indx_ary,
               "expression numeric identifier")  # 10 digits
...
find_unique_id(
    ...
    999999999999999,
    symbol_label_ary,
    "symbol numeric identifier")  # 15 digits
...
find_unique_id(
    ...
    9999999,
    feed_temporary_unique_id_ary,
    "feed numeric identifier")  # 7 digits
