...
Evaluate criteria relevant to users, including the 
\begin{itemize}
\item ability to input by humans
\item ability to transform between representations
\item ability to audit correctness
\end{itemize}

In this evaluation, the following characterizations are used for comparison of syntax methods
\begin{itemize}
\item can it describe all the notation necessary for physics
\item how easy is the input method? (character count)
\item can it be transformed to other representations
\end{itemize}
Storage of the generated content (knowledge base for all of physics) isn't expected to exceed a Gigabyte, so compactness in terms of storage isn't a criterion.
...
\section{Quantitative Comparison of Test Cases}
...
\section{Qualitative Comparisons of Syntax Methods}
...
\subsection{Transform representations}
...
\subsection{Audit Correctness of Derivations}
